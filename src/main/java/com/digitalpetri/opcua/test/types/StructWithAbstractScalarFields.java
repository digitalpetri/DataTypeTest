...
public class StructWithAbstractScalarFields extends Structure implements UaStructuredType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=3012");

  public static final ExpandedNodeId BINARY_ENCODING_ID = ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=5007");

  public static final ExpandedNodeId XML_ENCODING_ID = ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=5008");

  public static final ExpandedNodeId JSON_ENCODING_ID = ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=5009");
  ...
  public static StructureDefinition definition(NamespaceTable namespaceTable) {
    return new StructureDefinition(
      ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=5007").toNodeId(namespaceTable).orElseThrow(),
      ...
      new StructureField[]{
    		...
    		new StructureField("ATT1", LocalizedText.NULL_VALUE, ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=3003").toNodeId(namespaceTable).orElseThrow(), -1, null, UInteger.valueOf(0), true), 
    		new StructureField("ATT2", LocalizedText.NULL_VALUE, ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=3003").toNodeId(namespaceTable).orElseThrow(), -1, null, UInteger.valueOf(0), true)
    	}
    );
  }
