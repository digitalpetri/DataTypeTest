...
public class UnionOfArray extends Union {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=3023");

  public static final ExpandedNodeId BINARY_ENCODING_ID = ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=5032");

  public static final ExpandedNodeId XML_ENCODING_ID = ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=5033");

  public static final ExpandedNodeId JSON_ENCODING_ID = ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=5034");
  ...
  public static StructureDefinition definition(NamespaceTable namespaceTable) {
    return new StructureDefinition(
      ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=5032").toNodeId(namespaceTable).orElseThrow(),
  ...
  public static final class Codec extends GenericDataTypeCodec<UnionOfArray> {
    ...
    public UnionOfArray decodeType(EncodingContext context, UaDecoder decoder) {
      ...
      switch (switchValue.intValue()) {
        case 0: return UnionOfArray.ofNull();
        case 1: {
