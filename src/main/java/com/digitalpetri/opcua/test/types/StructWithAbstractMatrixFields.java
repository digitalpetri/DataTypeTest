...
public class StructWithAbstractMatrixFields extends Structure implements UaStructuredType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=3022");

  public static final ExpandedNodeId BINARY_ENCODING_ID = ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=5047");

  public static final ExpandedNodeId XML_ENCODING_ID = ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=5048");

  public static final ExpandedNodeId JSON_ENCODING_ID = ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=5049");
  ...
  public static StructureDefinition definition(NamespaceTable namespaceTable) {
    return new StructureDefinition(
      ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=5047").toNodeId(namespaceTable).orElseThrow(),
      ...
      new StructureField[]{
    		...
    		new StructureField("ATT1", LocalizedText.NULL_VALUE, ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=3003").toNodeId(namespaceTable).orElseThrow(), 2, new UInteger[]{UInteger.valueOf(2),UInteger.valueOf(2)}, UInteger.valueOf(0), true), 
    		new StructureField("ATT2", LocalizedText.NULL_VALUE, ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=3003").toNodeId(namespaceTable).orElseThrow(), 2, new UInteger[]{UInteger.valueOf(2),UInteger.valueOf(2)}, UInteger.valueOf(0), true)
    	}
    );
  }
