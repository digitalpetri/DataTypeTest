...
public class StructWithBuiltinMatrixFieldsEx extends StructWithBuiltinMatrixFields implements UaStructuredType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=3017");

  public static final ExpandedNodeId BINARY_ENCODING_ID = ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=5044");

  public static final ExpandedNodeId XML_ENCODING_ID = ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=5045");

  public static final ExpandedNodeId JSON_ENCODING_ID = ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=5046");
  ...
  public static StructureDefinition definition(NamespaceTable namespaceTable) {
    return new StructureDefinition(
      ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=5044").toNodeId(namespaceTable).orElseThrow(),
      ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=3010").toNodeId(namespaceTable).orElseThrow(),
      ...
      new StructureField[]{
    		...
    		new StructureField("TestEnumType", LocalizedText.NULL_VALUE, ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=3011").toNodeId(namespaceTable).orElseThrow(), 2, new UInteger[]{UInteger.valueOf(2),UInteger.valueOf(2)}, UInteger.valueOf(0), false), 
    		...
    		new StructureField("ConcreteTestType", LocalizedText.NULL_VALUE, ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=3006").toNodeId(namespaceTable).orElseThrow(), 2, new UInteger[]{UInteger.valueOf(2),UInteger.valueOf(2)}, UInteger.valueOf(0), false), 
    		new StructureField("UnionOfScalar", LocalizedText.NULL_VALUE, ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=3020").toNodeId(namespaceTable).orElseThrow(), 2, new UInteger[]{UInteger.valueOf(2),UInteger.valueOf(2)}, UInteger.valueOf(0), false), 
    		new StructureField("UnionOfArray", LocalizedText.NULL_VALUE, ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=3023").toNodeId(namespaceTable).orElseThrow(), 2, new UInteger[]{UInteger.valueOf(2),UInteger.valueOf(2)}, UInteger.valueOf(0), false), 
