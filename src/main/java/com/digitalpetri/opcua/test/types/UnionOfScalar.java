...
public class UnionOfScalar extends Union {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=3020");

  public static final ExpandedNodeId BINARY_ENCODING_ID = ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=5029");

  public static final ExpandedNodeId XML_ENCODING_ID = ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=5030");

  public static final ExpandedNodeId JSON_ENCODING_ID = ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=5031");
  ...
  public static StructureDefinition definition(NamespaceTable namespaceTable) {
    return new StructureDefinition(
      ExpandedNodeId.parse("nsu=https://github.com/digitalpetri/DataTypeTest;i=5029").toNodeId(namespaceTable).orElseThrow(),
  ...
  public static final class Codec extends GenericDataTypeCodec<UnionOfScalar> {
    ...
    public UnionOfScalar decodeType(EncodingContext context, UaDecoder decoder) {
      ...
      switch (switchValue.intValue()) {
        case 0: return UnionOfScalar.ofNull();
        case 1: {
